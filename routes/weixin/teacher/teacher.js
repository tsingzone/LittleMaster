...
var logger = require('../../../logger').logger('teacher.js');
...
// 获取简历填写比例
router.get('/profile/percentage', function (req, res) {
    logger.debug('简历填写比例');
    teacherController.getProfilePercentage(req, res);
});
